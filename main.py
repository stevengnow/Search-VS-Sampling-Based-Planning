...
def runtest(mapfile, start, goal, res, eps, verbose = True):
  '''
  This function:
  ...
  MP = A_star.A_star_Algorithm_Planner(boundary, blocks, res, eps)
  ...
  t0 = tic()
  path, CLOSED = MP.plan(start,goal)
  toc(t0,"Planning")
...
def test_single_cube(verbose = False):
  ...
  success, pathlength = runtest('./maps/single_cube.txt', start, goal, 0.5, 2, verbose)
...
def test_maze(verbose = False):
  ...
  success, pathlength = runtest('./maps/maze.txt', start, goal, 0.5, 2, verbose)
  print('Success: %r'%success)
  print('Path length: %d'%pathlength)
  print('\n')
...
def test_window(verbose = False):
  ...
  success, pathlength = runtest('./maps/window.txt', start, goal, 0.5, 2, verbose)
  print('Success: %r'%success)
  print('Path length: %d'%pathlength)
  print('\n')
...
def test_tower(verbose = False):
  ...
  success, pathlength = runtest('./maps/tower.txt', start, goal, 0.5, 2, verbose)
  print('Success: %r'%success)
  print('Path length: %d'%pathlength)
  print('\n')
...
def test_flappy_bird(verbose = False):
  ...
  success, pathlength = runtest('./maps/flappy_bird.txt', start, goal, 0.5, 2, verbose)
  print('Success: %r'%success)
  print('Path length: %d'%pathlength) 
  print('\n')
...
def test_room(verbose = False):
  ...
  success, pathlength = runtest('./maps/room.txt', start, goal, 0.5, 2, verbose)
  print('Success: %r'%success)
  print('Path length: %d'%pathlength)
  print('\n')
...
def test_monza(verbose = False):
  ...
  # goal = np.array([4.3, 19.0, 0.1])
  success, pathlength = runtest('./maps/monza.txt', start,  goal, 0.5, 2, verbose)
  print('Success: %r'%success)
  print('Path length: %d'%pathlength)
  print('\n')
